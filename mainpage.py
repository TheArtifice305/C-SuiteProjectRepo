...
db = SQLAlchemy()
bcrypt = Bcrypt(mainpage)
mainpage.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:///database.db'
mainpage.config['SECRET_KEY'] = 'thisisasecretkey'
db.init_app(mainpage)


login_manager = LoginManager()
login_manager.init_app(mainpage)
    ...
    def validate_username(self, username):
        ...
        if existing_user_username:
            raise ValidationError(
                'That username is already in use. Please create a different one.')
